...
function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-black bg-slate-500 py-3">

        <div className="container ml-2">
                <span className="text-4xl font-bold text-white ">Vizualize</span>
        </div>
        <div className="flex justify-center pb-8 ml-2">
