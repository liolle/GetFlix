...
const Footer: React.FunctionComponent = () => {
  ...
  return (
    ...
    <footer className=" ml-4  py-3">

        
        <div className="flex justify-center pb-8 ml-2 overflow-hidden text-white text-xl font-extralight mb-8">
                <span className="text-2xl font-bold text-white">Accessible On Your Favorite Devices</span>
        </div>
...
<div className='text-center text-md-start grid grid-cols-2 pt-5 text-white'>
            ...
            <div  className='mx-auto mb-4 md="3" lg="2" xl="2"'>
              <div className='text-2xl font-bold mb-4'>Useful Links</div>

              <p><a href='#!' className='font-extralight text-2xl'>Pricing</a></p>

              <p><a href='#!' className='font-extralight text-2xl'>Settings</a></p>

              <p><a href='#!' className='font-extralight text-2xl'>Orders</a></p>

              <p><a href='#!' className='font-extralight text-2xl'>Help</a></p>

            </div>
            <div  className='mb-4 md="3" lg="2" xl="2" pr-4'>
              <div className='text-2xl font-bold mb-4 '>Contact</div>

              <p className="font-extralight flex items-center justify-center text-2xl">
                <a href="#"><FaHome size={25}/>BE, Brussel 1000</a></p> 

              <span className="font-extralight flex items-center justify-center text-2xl">
        ...
        <div className="flex justify-center pb-3 pt-8 ml-2 text-white">
                <span className="text-2xl font-bold text-white">Get connected with us on Social Media</span>
          </div>
